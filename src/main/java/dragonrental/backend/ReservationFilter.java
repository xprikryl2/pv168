...
public class ReservationFilter {
        ...
        private LocalDateTime toIsAfterOrNull = null;
        ...
        public ReservationFilter withToIsAfterOrNull(LocalDateTime time) {
            this.toIsAfterOrNull = time;
            return this;
        }
        ...
        public String toSQL() {
            ...
            if (toIsAfterOrNull != null) {
                stringBuilder.append("( timeTo >= \'").append(Timestamp.valueOf(toIsAfterOrNull)).append("\' OR timeTo IS NULL )").append(" AND ");
                anyNull = true;
            }
            if (borrower != null) {
